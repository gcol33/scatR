...
test_that("spatial_gp creates valid object", {
  sp <- spatial_gp()
  expect_s3_class(sp, "scatr_spatial")
  expect_s3_class(sp, "scatr_spatial_gp")
...
test_that("spatial_spde creates valid object", {
  sp <- spatial_spde()
  expect_s3_class(sp, "scatr_spatial")
  expect_s3_class(sp, "scatr_spatial_spde")
...
test_that("spatial_car creates valid object", {
  ...
  expect_s3_class(sp, "scatr_spatial")
  expect_s3_class(sp, "scatr_spatial_car")
...
test_that("spatial_bym2 creates valid object", {
  sp <- spatial_bym2()
  expect_s3_class(sp, "scatr_spatial")
  expect_s3_class(sp, "scatr_spatial_bym2")
